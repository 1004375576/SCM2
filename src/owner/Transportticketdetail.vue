      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div style="margin-bottom:15px ;">
            运单号：<span style="color:#AA0000;padding-left:10px ;">{{LogisticId}}</span>
          </div>
          <el-row :gutter="20">
            <el-steps :active="orderStatus" align-center>
              <el-step :title="item.title" :description="item.description" v-for="item in itemss" v-bind:key="item.id"></el-step>
            </el-steps>

          </el-row>
          <div style="padding-left:10px ; margin-top:10px ;">
            订单号：<span style="color:#AA0000;padding-left:10px ;">{{orderid}}</span>&nbsp;&nbsp;&nbsp;
            发货单号：<span style="color:#AA0000;padding-left:10px ;">{{dispatchOrderid}}</span>
